...
Purpose:
Defines the basic ticket-lifecycle API: creating a ticket, listing your
own tickets, and fetching one. This is the "everyday user" surface —
agent-only queue actions (assign/accept/close/my-assignments) live in
app/api/agent.py, and admin metrics live in app/api/admin.py.
...
- Add agent/admin-only endpoints here — see app/api/agent.py and app/api/admin.py
"""
...
from app.schemas.feedback import FeedbackResponse, FeedbackCreateNested
